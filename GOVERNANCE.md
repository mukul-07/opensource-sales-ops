...
opensource-sales-ops is maintained by [@mukul-07](https://github.com/mukul-07) under a **BDFL (Benevolent Dictator for Life)** model with a clear path for community members to earn trust and take on responsibilities.
...
- **Documentation** — welcome from anyone, low barrier
...
- Open issues, comment on PRs, help others in Discussions
...
1. **Start contributing** — fix a bug, improve a mode, improve docs
2. **Be consistent** — one quality PR per month beats ten rushed ones
3. **Help others** — answer questions in Discussions, review PRs, triage issues
