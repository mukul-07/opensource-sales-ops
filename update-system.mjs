...
/**
 * update-system.mjs — Safe auto-updater for opensource-sales-ops
 *
...
const CANONICAL_REPO = 'https://github.com/mukul-07/opensource-sales-ops.git';
const RAW_VERSION_URL = 'https://raw.githubusercontent.com/mukul-07/opensource-sales-ops/main/VERSION';
const RELEASES_API = 'https://api.github.com/repos/mukul-07/opensource-sales-ops/releases/latest';
...
async function check() {
  // sales-ops fork: upstream pull disabled. Re-enable by repointing
  // CANONICAL_REPO / RAW_VERSION_URL / RELEASES_API to your own fork.
  console.log(JSON.stringify({ status: 'fork-disabled' }));
  return;
...
async function apply() {
  // sales-ops fork: upstream pull disabled. Re-enable by repointing
  // CANONICAL_REPO / RAW_VERSION_URL / RELEASES_API to your own fork.
  console.error('update-system.mjs is disabled in this sales-ops fork. Repoint the upstream URLs in this file to re-enable.');
  process.exit(0);
